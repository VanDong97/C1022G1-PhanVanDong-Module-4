...
<button type="button" class="btn btn-primary" onclick="location.href = '/player/create'">Thêm Mới Cầu Thủ</button>
<table>
    <tr>
        <th>Mã Cầu Thủ</th>
        <th>Tên Cầu Thủ</th>
        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-danger"
                        onclick="deletePlayer(${playerSoccer.id},'${playerSoccer.name}')"
                        data-toggle="modal" data-target="#exampleModal"> Xóa
                </button>
            </td>
            <td>
                <button type="button" onclick="location.href = '/player/edit/${playerSoccer.id}'"
        ...
        <div class="modal-content">
            ...
            <form action="/player/delete">
                <div class="modal-body">
                    ...
                    <span>Bạn Có Muốn Xóa Cầu Thủ </span><span style="color: red"
                                                               id="name"></span> Không ?
                </div>
