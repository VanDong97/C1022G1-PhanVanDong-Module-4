...
public class PlayerSoccerService implements IPlayerSoccerService {
    ...
    @Override
    public Object createPlayerSoccer(PlayerSoccer playerSoccer) {
        iPlayerSoccerRepository.createPlayerSoccer(playerSoccer);
        return null;
    }

    @Override
    public void editPlayerSoccer(PlayerSoccer playerSoccer) {
        iPlayerSoccerRepository.editPlayerSoccer(playerSoccer);
    }
}
