...
public class ProductController {
    ...
    @GetMapping("")
    public String showProduct(@RequestParam(required = false, defaultValue = "") String productName, Model model) {
    ...
    @GetMapping("/edit")
    public String showFormE(@RequestParam Integer id, Model model) {
        model.addAttribute("product", iProductService.findById(id));
        return "/edit";
    }
